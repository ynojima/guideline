 ...
 .. list-table::
    ...
    * - | Memory utilization
      - | Estimate the data size for which usage of session is considered. Assume maximum 100 characters 240 bytes (4 characters 8 bytes + initial 40 bytes) for the character string element, 24 bytes for data element and 16 bytes for the numerical value element. Further, the authentication information stored in the session at the time of login authentication also contains the size of \ "UserDetails"\ . \ "UserDetails"\  broadly contains ID, password and user rights. Multiple user rights can be specified, but assume here as 1. The result estimated for each item is as follows.
        ...
        * Cart information (maximum 19 productsÅ~ (Character string: 3, numerical value: 3)): maximum 14.6K bytes
    ...
    session-tutorial-init-domain
        Ñ§ÑüÑü src
            Ñ§ÑüÑü main
              ...
              ?? Ñ†??             Ñ§ÑüÑü domain
              ?? Ñ†??                 Ñ•ÑüÑü model  ... (1)
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü Account.java  ... (2)
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü Cart.java  ... (3)
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü CartItem.java  ... (3)
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü Goods.java
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü Order.java  ... (4)
              ?? Ñ†??                 Ñ†  Ñ§ÑüÑü OrderLine.java  ... (4)
              ?? Ñ†??                 Ñ•ÑüÑü repository  ... (5)
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü account
              ?? Ñ†??                 Ñ†  Ñ†  Ñ§ÑüÑü AccountRepository.java
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü goods
              ?? Ñ†??                 Ñ†  Ñ†  Ñ§ÑüÑü GoodsRepository.java
              ?? Ñ†??                 Ñ†  Ñ§ÑüÑü order
              ?? Ñ†??                 Ñ†      Ñ§ÑüÑü OrderRepository.java
              ?? Ñ†??                 Ñ§ÑüÑü service  ... (6)
              ?? Ñ†??                     Ñ•ÑüÑü account
              ?? Ñ†??                     Ñ†  Ñ§ÑüÑü AccountService.java
              ?? Ñ†??                     Ñ•ÑüÑü goods
              ?? Ñ†??                     Ñ†  Ñ§ÑüÑü GoodsService.java
              ?? Ñ†??                     Ñ•ÑüÑü order
              ?? Ñ†??                     Ñ†  Ñ•ÑüÑü EmptyCartOrderException.java
              ?? Ñ†??                     Ñ†  Ñ•ÑüÑü InvalidCartOrderException.java
              ?? Ñ†??                     Ñ†  Ñ§ÑüÑü OrderService.java
              ?? Ñ†??                     Ñ§ÑüÑü userdetails
              ?? Ñ†??                         Ñ•ÑüÑü AccountDetails.java
              ?? Ñ†??                         Ñ§ÑüÑü AccountDetailsService.java
              ?? Ñ§ÑüÑü resources
              ??   ?? Ñ•ÑüÑü com
              ??   ?? Ñ†  Ñ§ÑüÑü example
              ??   ?? Ñ†      Ñ§ÑüÑü session
              ??   ?? Ñ†          Ñ§ÑüÑü domain
              ??   ?? Ñ†              Ñ§ÑüÑü repository  ... (7)
              ??   ?? Ñ†                  Ñ•ÑüÑü account
              ??   ?? Ñ†                  Ñ†  Ñ§ÑüÑü AccountRepository.xml
              ??   ?? Ñ†                  Ñ•ÑüÑü goods
              ??   ?? Ñ†                  Ñ†  Ñ§ÑüÑü GoodsRepository.xml
              ??   ?? Ñ†                  Ñ§ÑüÑü order
              ??   ?? Ñ†                      Ñ§ÑüÑü OrderRepository.xml
              ??   ?? Ñ§ÑüÑü META-INF
              ??   ??   ?? Ñ•ÑüÑü dozer
              ??   ??   ?? Ñ†? Ñ§ÑüÑü order-mapping.xml  ... (8)
              ??   ??   ?? Ñ§ÑüÑü spring
              ??   ??   ??     Ñ§ÑüÑü session-tutorial-init-codelist.xml  ... (9)
    ...
    session-tutorial-init-env
        Ñ§ÑüÑü src
            Ñ§ÑüÑü main
                 Ñ§ÑüÑü resources
              ??  ?? Ñ§ÑüÑü database  ... (1)
              ??  ??     Ñ•ÑüÑü H2-dataload.sql
              ??  ??     Ñ§ÑüÑü H2-schema.sql
    ...
    session-tutorial-init-web
        Ñ§ÑüÑü src
            Ñ§ÑüÑü main
              ...
              ?? Ñ†??             Ñ§ÑüÑü app  ... (1)
              ?? Ñ†??                 Ñ•ÑüÑü account 
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü AccountCreateController.java 
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü AccountCreateForm.java 
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü IlleagalOperationException.java  
              ?? Ñ†??                 Ñ†  Ñ§ÑüÑü IlleagalOperationExceptionHandler.java
              ?? Ñ†??                 Ñ•ÑüÑü goods
              ?? Ñ†??                 Ñ†  Ñ•ÑüÑü GoodsController.java  
              ?? Ñ†??                 Ñ†  Ñ§ÑüÑü GoodsViewForm.java
              ?? Ñ†??                 Ñ•ÑüÑü login
              ?? Ñ†??                 Ñ†  Ñ§ÑüÑü LoginController.java
              ?? Ñ†??                 Ñ§ÑüÑü validation
              ?? Ñ†??                     Ñ•ÑüÑü Confirm.java
              ?? Ñ†??                     Ñ§ÑüÑü ConfirmValidator.java
              ?? Ñ•ÑüÑü resources
              ?? Ñ†?? Ñ•ÑüÑü i18n
              ?? Ñ†?? Ñ†  Ñ§ÑüÑü application-messages.properties  ... (2)
              ?? Ñ†?? Ñ•ÑüÑü META-INF
              ?? Ñ†?? Ñ† ? Ñ§ÑüÑü spring  ... (3)
              ?? Ñ†?? Ñ†??     Ñ•ÑüÑü spring-mvc.xml
              ?? Ñ†?? Ñ†??     Ñ§ÑüÑü spring-security.xml
              ?? Ñ†?? Ñ§ÑüÑü ValidationMessages.properties  ... (2)
              ?? Ñ§ÑüÑü webapp
              ??   ?? Ñ•ÑüÑü resources  ... (4)
              ??   ?? Ñ†  Ñ•ÑüÑü app
              ??   ?? Ñ†  Ñ†  Ñ§ÑüÑü css
              ??   ?? Ñ†  Ñ†      Ñ§ÑüÑü styles.css
              ??   ?? Ñ†  Ñ§ÑüÑü vendor
              ??   ?? Ñ†      Ñ§ÑüÑü bootstrap-3.0.0
              ??   ?? Ñ†          Ñ§ÑüÑü css
              ??   ?? Ñ†              Ñ§ÑüÑü bootstrap.css
              ??   ?? Ñ§ÑüÑü WEB-INF
              ??       ?? Ñ§ÑüÑü views  ... (5)
              ??       ??     Ñ•ÑüÑü account
              ??       ??     Ñ†  Ñ•ÑüÑü createConfirm.jsp
              ??       ??     Ñ†  Ñ•ÑüÑü createFinish.jsp
              ??       ??     Ñ†  Ñ§ÑüÑü createForm.jsp
              ??       ??     Ñ•ÑüÑü common
              ??       ??     Ñ†  Ñ•ÑüÑü error
              ??       ??     Ñ†  Ñ†  Ñ§ÑüÑü illegalOperationError.jsp
              ??       ??     Ñ†  Ñ§ÑüÑü include.jsp
              ??       ??     Ñ•ÑüÑü goods
              ??       ??     Ñ†  Ñ•ÑüÑü showGoods.jsp
              ??       ??     Ñ†  Ñ§ÑüÑü showGoodsDetails.jsp
              ??       ??     Ñ§ÑüÑü login
              ??       ??         Ñ§ÑüÑü loginForm.jsp
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><span id="orderDate"><fmt:formatDate
                                value="${order.orderDate}" pattern="yyyy-MM-ddÅ@hh:mm:ss" /></span></td>
                </tr>
            </table>
            <table>
                <tr>

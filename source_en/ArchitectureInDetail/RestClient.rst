    ...
    * - | (5)
      ...
      - | A class for conversion of "HTTP body ⇔ \ ``MultiValueMap``\  object".
        ...
        * When media type is \ ``multipart/form-data``\ , data is written as \ ``MultiValueMap<String, Object>``\  and \ ``Object``\  is converted by \ ``HttpMessageConveter``\  configured separately in \ ``AllEncompassingFormHttpMessageConverter``\ .
        ...
        | Refer `AllEncompassingFormHttpMessageConverter <https://github.com/spring-projects/spring-framework/blob/v4.2.2.RELEASE/spring-web/src/main/java/org/springframework/http/converter/support/AllEncompassingFormHttpMessageConverter.java>`_\  and
          `FormHttpMessageConverter <https://github.com/spring-projects/spring-framework/blob/v4.2.2.RELEASE/spring-web/src/main/java/org/springframework/http/converter/FormHttpMessageConverter.java>`_\  source for \ ``HttpMessageConveter``\  used for conversion of part data which is registered by default. Note that, it is also possible to register an arbitrary \ ``HttpMessageConverter``\ .
      - | ``MultiValueMap`` [#p3]_
...
.. note:: **Regarding HTTP method supported by RestTemplate**
    ...
    Refer Javadoc of \ `RestTemplate <http://docs.spring.io/spring/docs/4.2.2.RELEASE/javadoc-api/org/springframework/web/client/RestTemplate.html>`_\  for details.
...
.. note:: **ResponseEntity**
    ...
    Refer Javadoc of \ `ResponseEntity <http://docs.spring.io/spring/docs/4.2.2.RELEASE/javadoc-api/org/springframework/http/ResponseEntity.html>`_\  for details.
...
.. note:: **RequestEntity**
    ...
    Refer Javadoc of \ `RequestEntity <http://docs.spring.io/spring/docs/4.2.2.RELEASE/javadoc-api/org/springframework/http/RequestEntity.html>`_\  for details.
...
.. list-table::
    ...
    * - | (2)
      - | By using ``UriComponentsBuilder``\ , first variable of URI template is replaced by value specified in the argument of ``buildAndExpand``\  and "http://localhost:8080/api/users/create" URI is created.
        | Refer Javadoc of \ `UriComponentsBuilder <http://docs.spring.io/spring/docs/4.2.2.RELEASE/javadoc-api/org/springframework/web/util/UriComponentsBuilder.html>`_\  for details.
...
.. note:: **How to customise AsyncRestTemplate**
    ...
    Refer Javadoc of \ `AsyncRestTemplate <http://docs.spring.io/spring/docs/current/javadoc-api/org/springframework/web/client/AsyncRestTemplate.html>`_\  for details.
    
    Also, customisation for other than thread pool size is possible for \ ``ThreadPoolTaskExecutor``\ as well.
    Refer Javadoc of \ `ThreadPoolTaskExecutor <http://docs.spring.io/spring/docs/4.2.2.RELEASE/javadoc-api/org/springframework/scheduling/concurrent/ThreadPoolTaskExecutor.html>`_\  for details.

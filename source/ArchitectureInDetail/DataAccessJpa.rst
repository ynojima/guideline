...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
 .. note:: **最新バージョンを利用する**
     ...
     過去のバージョンでは、すべてのRepositoryインタフェースに一括でカスタムメソッドを追加する方法の説明ありましたが、 
     新バージョンでの主な変更点がありましたため、古いコンテンツを削除した。
     すべてのRepositoryインタフェースに一括でカスタムメソッドを追加する方法のため最新バージョンを使用することを推奨。
     
     新しいバージョンでは、共通Repositoryインタフェースの実装クラスのインスタンスを生成するためのFactoryクラスの実装は不要です。
     Spring Data JPAより提供されている SimpleJpaRepository クラスの findOne メソッドおよび findAll 系メソッドに対して、 @Lock アノテーションを使ってロックモードを指定できるようなコードも不要です。

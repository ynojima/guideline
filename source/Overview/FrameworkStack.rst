...
.. list-table::
    ...
    * - \ (2)
      ...
      - 文字列処理に関連する機能を提供する。依存ライブラリがないため単独でも利用可能。(5.1.0から追加)
      - 有
    * - \ (3)
      - terasoluna-gfw-codepoints
      - 対象の文字列を構成するコードポイントがコードポイント集合に含まれることをチェックする機能を提供する。Bean Validation API以外の依存ライブラリがないため単独でも利用可能。(5.1.0から追加)
      - 有
    * - \ (4)

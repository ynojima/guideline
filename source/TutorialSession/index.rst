...
アプリケーションの概要を以下の図に示す。各画面群(Pages)が1つのユースケースに対応する。
...
提供するプロジェクトでは、あらかじめ一部の機能が作成されている。
本チュートリアルでは、未完成の機能を作成する。
また、未完成の機能においても、ドメイン層・インフラストラクチャ層の実装は提供されている。
...
本チュートリアルでは、アプリケーションを作成する際に以下の非機能要件を考慮する必要がある。
